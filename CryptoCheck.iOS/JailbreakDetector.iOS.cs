...
using CryptoCheck.Inspectors;

namespace CryptoCheck.iOS
{
    /// <summary>
    /// iOS implementation of the Jailbreak Detector.
    /// </summary>
    public class JailbreakDetector : CryptoCheck.JailbreakDetector
    {
        /// <summary>
        ...
        public JailbreakDetector(CryptoCheck.Ex.Env env, bool? simulatorFriendly = null)
            : base(env)
        {
            ...
            this.AddInspectors(PathsShouldNotBeSymbolicLinks.GetInspectors<CryptoCheck.iOS.PlatformSpecific.PathNotSymbolicLink>());
            ...
            this.AddInspectors(UrlsShouldNotBeOpenable.GetInspectors<CryptoCheck.iOS.PlatformSpecific.UrlNotOpenable>());
